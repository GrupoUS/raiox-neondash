...
```bash
python .Codex/skills/skill-creator/scripts/init_skill.py <skill-name> --path <output-dir>
```
...
```bash
python .Codex/skills/skill-creator/scripts/run_loop.py \
