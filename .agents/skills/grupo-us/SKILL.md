...
- **UI or layout** that changes home journey, product grid order, CTAs, landing copy, or JSON in `src/content/products/` — load this skill **early**, together with `astro` / `gpus-theme` (see `.Codex/commands/design.md`).
